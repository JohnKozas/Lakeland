class Ticket_Agent extends Employee {
    ...
    public Ticket issueTicket(int ticketId, Customer cst, int flightDate, String arrivalAirportId, String departureAirportId, String flightId, Float ticketCost, Float discount, String ticketBasis){
        Work = Work + "Ticket " + ticketId + ", ";
        return new Ticket(ticketId, cst, flightDate, arrivalAirportId, departureAirportId, flightId, ticketCost, discount, ticketBasis);
    }
    ...
    public Reservation makeReservation(int reservationId, int reservationDate, int customerId, int flightId, int availUntilDate){
        ...
        return new Reservation(reservationDate, customerId, flightId, availUntilDate);
    }

    public Booking makeBooking(int bookingId, int ticketId, int customerId, int flightId){
        Work = Work + "Booking " +  bookingId + ", ";
        return new Booking(ticketId, customerId, flightId);
    }
